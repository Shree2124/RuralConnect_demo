...
export function TopNav({ sidebarWidth, onMobileMenuToggle }: { sidebarWidth: number; onMobileMenuToggle?: () => void }) {
  ...
  return (
    <header
      className="fixed top-7 right-0 z-30 bg-white/80 backdrop-blur-sm border-b border-blue-50 transition-all duration-300"
    ...
    >
      ...
      <div className="flex items-center justify-between px-3 sm:px-4 py-3 gap-3">
        ...
        <button
          ...
          className="lg:hidden flex items-center justify-center w-9 h-9 rounded-lg hover:bg-slate-100 text-slate-600 transition-colors flex-shrink-0"
        ...
        {/* Left: Search — hidden on xs, visible from sm */}
